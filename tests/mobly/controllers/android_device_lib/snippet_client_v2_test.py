...
class SnippetClientV2Test(unittest.TestCase):
  ...
  @mock.patch('mobly.controllers.android_device_lib.snippet_client_v2.adb.list_occupied_adb_ports', return_value=[12345])
  @mock.patch('mobly.utils.stop_standing_subprocess')
  ...
  def test_stop_with_device_side_error(
      self, mock_adb_shell, mock_stop_standing_subprocess, _,
  ):
