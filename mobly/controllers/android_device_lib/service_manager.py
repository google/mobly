...
class ServiceManager(object):
  ...
  def register(self, alias, service_class, configs=None, start_service=True):
    ...
    Args:
      ...
      configs: (optional) config object to pass to the service class's
        constructor.
      start_service: bool, whether to start the service instance or not. Default
        is True.
    """
  ...
  def for_each(self, func):
    ...
    Args:
      func: function, the function to execute. This function should take a
        service object as args.
    """
  ...
  def create_output_excerpts_all(self, test_info):
    ...
    Args:
      test_info: RuntimeTestInfo, the test info associated with the scope of the
        excerpts.
