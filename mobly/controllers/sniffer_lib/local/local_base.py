...
class SnifferLocalBase(sniffer.Sniffer):
  ...
  def _pre_capture_config(self, override_configs=None):
    """Utility function which configures the wireless interface per the specified configurations.

    Operation is performed before every capture
  ...
  def _get_command_line(self,
                        ...
                        duration=None,
                        packet_count=None):
    """Utility function to be implemented by every child class - which are the concrete sniffer classes.

    Each sniffer-specific class should
  ...
  def _post_process(self):
    """Utility function which is executed after a capture is done.

    It moves the capture file to the requested location.
    """
    self._process = None
