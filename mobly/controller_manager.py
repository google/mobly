...
def verify_controller_module(module):
  ...
  Args:
    module: An object that is a controller module. This is usually imported with
      import statements or loaded by importlib.
...
class ControllerManager(object):
  ...
  def _create_controller_info_record(self, controller_module_name):
    ...
    Args:
      controller_module_name: string, the name of the controller module to
        retrieve info from.
