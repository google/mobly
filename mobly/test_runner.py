...
def main(argv=None):
    ...
    for config in test_configs:
        ...
        runner.add_test_class(config, test_class, test_case_names)
        try:
            runner.run()
...
class TestRunner(object):
    ...
    results for all testcases that have been added to this runner.
    ...
    class _TestRunInfo(object):
        ...
        def __init__(self, config, test_class, test_methods=None):
            self.config = config
    ...
    def add_test_class(self, config, test_class, test_methods=None):
    ...
    def _run_test_class(self, config, test_class, test_methods=None):
        """Instantiates and executes a test class.

        If test_methods is None, the methods listed in self.tests will be
        executed instead. If self.tests is empty as well, every test method in
        ...
        with test_class(config) as test_instance:
            try:
                cls_result = test_instance.run(test_methods)
